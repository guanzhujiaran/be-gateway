...
(async function () {
    const global_var = {//全局变量
        ...
        Baidu_wenxin: {
            ...
            API_Key: `ugSnwBS1oMWQ4dkxSgwGHAfSSLeWORd0`,
            Secret_key: `gcLIPUOPagEfRLeGud86dzjnzt0UjDD1`,
    ...
    const utl = {
        ...
        remove_emoji_topic_at: (origin_str) => {//移除表情包和话题和@
            ...
            if (!at_re.test(origin_str)) {//如果没有@自己的尝试将@后面内容替换
                origin_str = origin_str.replaceAll(/@.{0,12} |@.{0,12}$/gmi, '')
    ...
    let my_operator = {
        basic_operator: {
            check_reply: async function (response_json, dynamic_id) {
                ...
                if (dynamic_id) {
                    ...
                    let comment_id_str = dynamic_detail_res.data.item.basic.comment_id_str
                    let comment_type = dynamic_detail_res.data.item.basic.comment_type
                    let reply_res = await MYAPI.BiliAPI.get_reply_main(0, 0, comment_id_str, comment_type)
                    if (reply_res.code) {
                        ...
                        if (replies.find(element => element.member.uname == global_var.user_info.uname)) {
                            return true
                        }
                        else {
                            return false
        ...
        comment_repost_dynamic_without_content: async function (comment_msg) { //转评不带回复内容
            ...
            try {
                ...
                console.warn(`${global_var.response.create_dyn_response}\t${global_var.pageurl}\t${global_var.user_info.uname}`)
        ...
        copy_reply_module: {//抄评论模块
            ...
            copy_reply_judge: (dynamic_content) => {
                ...
                let manual_re76 = /.*留下((?!抽奖|,|，).){0,5}“|.*留下((?!抽奖|,|，).){0,5}【|.*留下((?!抽奖|,|，).){0,5}:|.*留下((?!抽奖|,|，).){0,5}：|.*留下((?!抽奖|,|，).){0,5}「/gmi.test(dynamic_content)
                let manual_re77 = /.*留言((?!抽奖|,|，).).{0,7}“|.*留言((?!抽奖|,|，).){0,7}【|.*留言((?!抽奖|,|，).){0,7}:|.*留言((?!抽奖|,|，).){0,7}：|.*留言((?!抽奖|,|，).){0,7}「/gmi.test(dynamic_content)
                let manual_re6 = /.*@TA|.*@.{0,15}朋友|.*艾特|.*@.{0,3}你的|.*标记.{0,10}朋友|.*@{0,15}赞助商|.*发表你的新年愿望\+个人的昵称|.*抽奖规则请仔细看图片|.*带上用户名|.*此视频|.*视频评论区|.*活动详情请戳图片/gmi.test(dynamic_content)
                let manual_re75 = /.*本周话题|.*互动话题|.*互动留言|.*互动时间|.*征集.{0,10}名字|.*投票.{0,5}选.{0,10}最.{0,5}的|.*一人说一个谐音梗|帮.{0,5}想想.{0,5}怎么/gmi.test(dynamic_content)
    ...
    global_var.user_info.uname = '保加利亚人妖王'
    let copy_res = await my_operator.copy_reply_module.get_copy_reply('789777501628924005', 1, 0.9)
    console.log(copy_res);
    global_var.response.global_dynamic_data = {
        "item": {
            "basic": {
                "comment_id_str": "239108653",
                "comment_type": 11,
                "jump_url": "//www.bilibili.com/opus/789777501628924005",
                "like_icon": {
                    "action_url": "",
                    "end_url": "",
                    "id": 0,
            ...
            "modules": {
                "module_author": {
                                        ...
                                        "res_image": {
                                            "image_src": {
                                                ...
                                                "remote": {
                                                    ...
                                                    "url": "https://i2.hdslb.com/bfs/face/8c0407c5167c50423bf1084cc64306a0d8ca4765.jpg"
                                                },
                                                "src_type": 1
                                            }
                                        },
                    ...
                    "face": "https://i2.hdslb.com/bfs/face/8c0407c5167c50423bf1084cc64306a0d8ca4765.jpg",
                    "face_nft": false,
                    "following": null,
                    "jump_url": "//space.bilibili.com/578270486/dynamic",
                    "label": "",
                    "mid": 578270486,
                    "name": "Segotep鑫谷",
                    "official_verify": {
                ...
                "module_dynamic": {
                    ...
                    "desc": {
                        "rich_text_nodes": [
                            {
                                "orig_text": ">>见所未见——重构视装新体验<<\n昆仑2代360——带屏显的水冷来啦~~\n-------------------------------\n1体式3in1免锁风扇设计\n2.1英寸LCD显示屏\n323PPI带重力感应\n4GB存储容量\n5年质保\n6000转隐藏式温控水泵\n70MM嵌入式冷头风扇\n更多信息见图~~\n-------------------------------\n\n重磅新品发布哪有不抽奖的呢！先抽一台以表心意！\n如果粉丝数量能达到3W的话，再加抽一台也不是不可以的...\n\r\n规则：关注",
                                "text": ">>见所未见——重构视装新体验<<\n昆仑2代360——带屏显的水冷来啦~~\n-------------------------------\n1体式3in1免锁风扇设计\n2.1英寸LCD显示屏\n323PPI带重力感应\n4GB存储容量\n5年质保\n6000转隐藏式温控水泵\n70MM嵌入式冷头风扇\n更多信息见图~~\n-------------------------------\n\n重磅新品发布哪有不抽奖的呢！先抽一台以表心意！\n如果粉丝数量能达到3W的话，再加抽一台也不是不可以的...\n\r\n规则：关注",
                            ...
                            {
                                "orig_text": " ，点赞+转发并@2位好友，并留下你对昆仑2代水冷评价和建议等就有机会获得【昆仑2代 一体式360水冷散热器】一台~（黑白颜色随机）\r\n开奖时间为5月19日，中奖名单公布后的5个自然日内未联系后台的按弃奖处理，如果抽到不符合规则的小可爱，比如没有【关注】什么的，则会重抽～\nTips：随机抽取后ID后会审查评论内容，契合规则的评论中奖率会更高，大家一定要看清楚规则哦！！ \r\n顺祝大家假期愉快~假后昆仑2代水冷视频见~\r\n",
                                "text": " ，点赞+转发并@2位好友，并留下你对昆仑2代水冷评价和建议等就有机会获得【昆仑2代 一体式360水冷散热器】一台~（黑白颜色随机）\r\n开奖时间为5月19日，中奖名单公布后的5个自然日内未联系后台的按弃奖处理，如果抽到不符合规则的小可爱，比如没有【关注】什么的，则会重抽～\nTips：随机抽取后ID后会审查评论内容，契合规则的评论中奖率会更高，大家一定要看清楚规则哦！！ \r\n顺祝大家假期愉快~假后昆仑2代水冷视频见~\r\n",
                                "type": "RICH_TEXT_NODE_TYPE_TEXT"
                            },
                            {
                                "jump_url": "//search.bilibili.com/all?keyword=%E4%BA%92%E5%8A%A8%E6%8A%BD%E5%A5%96",
                                "orig_text": "#互动抽奖#",
                                "text": "#互动抽奖#",
                            ...
                            {
                                "jump_url": "//search.bilibili.com/all?keyword=%E6%8A%BD%E5%A5%96",
                                "orig_text": "#抽奖#",
                                "text": "#抽奖#",
                                "type": "RICH_TEXT_NODE_TYPE_TOPIC"
                            },
                            ...
                            {
                                "jump_url": "//search.bilibili.com/all?keyword=%E4%BE%9B%E7%94%B5%E5%B1%80%E7%A6%8F%E5%88%A9%E7%A4%BE",
                                "orig_text": "#供电局福利社#",
                                "text": "#供电局福利社#",
                                "type": "RICH_TEXT_NODE_TYPE_TOPIC"
                            },
                            ...
                            {
                                "jump_url": "//search.bilibili.com/all?keyword=%E8%BD%AC%E5%8F%91%E6%8A%BD%E5%A5%96",
                                "orig_text": "#转发抽奖#",
                                "text": "#转发抽奖#",
                                "type": "RICH_TEXT_NODE_TYPE_TOPIC"
                            }
                        ],
                        "text": ">>见所未见——重构视装新体验<<\n昆仑2代360——带屏显的水冷来啦~~\n-------------------------------\n1体式3in1免锁风扇设计\n2.1英寸LCD显示屏\n323PPI带重力感应\n4GB存储容量\n5年质保\n6000转隐藏式温控水泵\n70MM嵌入式冷头风扇\n更多信息见图~~\n-------------------------------\n\n重磅新品发布哪有不抽奖的呢！先抽一台以表心意！\n如果粉丝数量能达到3W的话，再加抽一台也不是不可以的...\n\r\n规则：关注@Segotep鑫谷 ，点赞+转发并@2位好友，并留下你对昆仑2代水冷评价和建议等就有机会获得【昆仑2代 一体式360水冷散热器】一台~（黑白颜色随机）\r\n开奖时间为5月19日，中奖名单公布后的5个自然日内未联系后台的按弃奖处理，如果抽到不符合规则的小可爱，比如没有【关注】什么的，则会重抽～\nTips：随机抽取后ID后会审查评论内容，契合规则的评论中奖率会更高，大家一定要看清楚规则哦！！ \r\n顺祝大家假期愉快~假后昆仑2代水冷视频见~\r\n#互动抽奖# #抽奖# #供电局福利社# #转发抽奖#"
                    },
                    "major": {
                        "draw": {
                            "id": 239108653,
                            "items": [
                                {
                                    "height": 1434,
                                    "size": 514.4199,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/5bbb7420c7689494b860f4fd0c2825dc578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1434,
                                    "size": 378.833,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/7ef72a9283ba1bd1042428aa5ce30753578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1434,
                                    "size": 376.79297,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/7a5803426ff84d091e162f1629a60bc7578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1434,
                                    "size": 248.27734,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/b0c411d5c7a4fc6db63df0458baa50ed578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1500,
                                    "size": 279.0869,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/becc707c4601778282ad7b14729ec5e9578270486.jpg",
                                    "tags": [],
                                    "width": 1500
                                },
                                {
                                    "height": 1434,
                                    "size": 314.3164,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/4d362b2bc90b314a63d22dac0be03492578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1434,
                                    "size": 391.2666,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/fae859e2d47c96aeafa2e464d64be126578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1434,
                                    "size": 401.6963,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/64d28ac75ccc9bf6e25af05a89704d2c578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                },
                                {
                                    "height": 1113,
                                    "size": 297.12598,
                                    "src": "https://i0.hdslb.com/bfs/new_dyn/da18ecc42543f814cc67b2474ac82655578270486.jpg",
                                    "tags": [],
                                    "width": 990
                                }
                            ]
    ...
    let lottery_setting = { copy_reply_module: { comment_copy_chance: 1 } };
    lottery_setting.at_member = ['斯卡蒂', '也']
    let 生成评论 = await my_operator.dynamic_comment_operator.reply_comment_generator(
        `">>见所未见——重构视装新体验<<
        昆仑2代360——带屏显的水冷来啦~~
        -------------------------------
        1体式3in1免锁风扇设计
        ...
        如果粉丝数量能达到3W的话，再加抽一台也不是不可以的...
        \r
        规则：关注@Segotep鑫谷 ，点赞+转发并@2位好友，并留下你对昆仑2代水冷评价和建议等就有机会获得【昆仑2代 一体式360水冷散热器】一台~（黑白颜色随机）\r
        开奖时间为5月19日，中奖名单公布后的5个自然日内未联系后台的按弃奖处理，如果抽到不符合规则的小可爱，比如没有【关注】什么的，则会重抽～
        Tips：随机抽取后ID后会审查评论内容，契合规则的评论中奖率会更高，大家一定要看清楚规则哦！！ \r
        顺祝大家假期愉快~假后昆仑2代水冷视频见~\r
        #互动抽奖# #抽奖# #供电局福利社# #转发抽奖#null'"`,
        `789777501628924005`
    );
    console.log(`生成评论：${生成评论}`)
    //let paraphrase_res = await my_operator.copy_reply_module.wenxin_paraphrase(copy_res);
    // console.log(paraphrase_res);
    // let check_res = await my_operator.basic_operator.check_reply(undefined, 783606522712162308n)
