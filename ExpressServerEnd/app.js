...
const LotteryDatabaseBiliRouter = require("./routes/lottery_database_bili");
...
// 导入服务
const { system_mq_task_manager } = require("./Service/background_task_module/system_mq_task_service");
