	...
	main = async () => {
		...
		let my_operator = {
			basic_operator: {
				 ...
				 */
				get_opus_dynamic_repost_area_content: async (
					page,
					css_selector
				) => {
					return await page.$eval(css_selector, async (el) => {
						let ret_msg = "";
									...
									case 0:
										...
										comment_msg =
											...
											para_msg == ""
												? copy_msg
												: para_msg;
										if (get_comment_times >= 3 && !comment_msg) {
											console.warn(
...
答：`;
							...
							let result = res.data;
							if (!result) {
								throw Error(`ai回复结果为空！`, res_string);
							}
							console.log(
								{
